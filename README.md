...
[![Version](https://vsmarketplacebadges.dev/version/acolovic.aql-formatter.svg)](https://marketplace.visualstudio.com/items?itemName=acolovic.aql-formatter) [![Installs](https://vsmarketplacebadges.dev/installs/acolovic.aql-formatter.svg)](https://marketplace.visualstudio.com/items?itemName=acolovic.aql-formatter) [![Rating](https://vsmarketplacebadges.dev/rating-star/acolovic.aql-formatter.svg)](https://marketplace.visualstudio.com/items?itemName=acolovic.aql-formatter) [![CI](https://github.com/FenrirTheGray/aql-formatter/actions/workflows/ci.yml/badge.svg)](https://github.com/FenrirTheGray/aql-formatter/actions/workflows/ci.yml) [![License: GPL v3](https://img.shields.io/badge/license-GPL--3.0-blue)](LICENSE)
